const Projects = () => {
  return (
    <div className="px-44 mt-10">
      <h1>💾 Download IGNOU Project and IGNOU Synopsis instantly</h1>
      <div className="w-[100%] mx-auto bg-teal-950 p-7 text-white mb-10">
        <h1 className="text-center text-white mb-5">IGNOU MBA PROJECT</h1>
      ...
      <div className="w-[100%] mx-auto bg-teal-950 p-7 text-white mb-10">
        <h1 className="text-center text-white mb-5">IGNOU BTS PROJECT</h1>
        <p className="text-center text-lg">
      ...
      <div className="w-[100%] mx-auto bg-teal-950 p-7 text-white mb-10">
        <h1 className="text-center text-white mb-5">IGNOU AHE PROJECT</h1>
        <p className="text-center text-lg">
      ...
      <div className="w-[100%] mx-auto bg-teal-950 p-7 text-white mb-10">
        <h1 className="text-center text-white mb-5">IGNOU DNHE PROJECT</h1>
        <p className="text-center text-lg">
      ...
      <div className="w-[100%] mx-auto bg-teal-950 p-7 text-white mb-10">
        <h1 className="text-center text-white mb-5">IGNOU MTTM PROJECT</h1>
        <p className="text-center text-lg">
      ...
      <div className="w-[100%] mx-auto bg-teal-950 p-7 text-white mb-10">
        <h1 className="text-center text-white mb-5">IGNOU MARD PROJECT</h1>
        <p className="text-center text-lg">
      ...
      <div className="w-[100%] mx-auto bg-teal-950 p-7 text-white mb-10">
        <h1 className="text-center text-white mb-5">
          CUSTOMIZED IGNOU PROJECT OF ANY COURSE
        </h1>
        <p className="text-center text-lg">
          We are here to assist you with your IGNOU Project work. You may order
          a customised project here; either you provide a topic or we will
          create one for you based on your synopsis, and if your synopsis is
          accepted, we will also create a report on it. If you wish to have any
