...
const Blog = () => (
  <div className="p-5">
    ...
    <article>
      ...
      <p>
        Writing IGNOU assignments can be overwhelming. We provide professionally
        handwritten assignments, ensuring 100% acceptance by IGNOU.
      </p>
      <br />
      ...
      <ul>
        ...
        <li>
          🚀 Fast Delivery Across India – Receive within 8-10 business days.
        </li>
        <li>📖 Covers All IGNOU Courses – Available for UG & PG programs.</li>
      </ul>
      <br />
      ...
      <p>
        <strong>
          Save time and submit your IGNOU assignment hassle-free! Order today.
        </strong>
      </p>
    </article>
  </div>
